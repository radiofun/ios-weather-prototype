...
class WeatherAppViewController: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let weatherScrollContainer = UIView(frame: CGRectMake(0, 210, self.view.frame.size.width, self.view.frame.size.height - 210))
            weatherScrollContainer.clipsToBounds = true
        
        self.view.addSubview(weatherScrollContainer)
        
        self.weatherScroll = UIScrollView(frame: CGRectMake(0, 0, weatherScrollContainer.frame.size.width, weatherScrollContainer.frame.size.height))
        ...
        self.todayScroll = UIScrollView(frame: CGRectMake(0, 325, self.view.frame.size.width, 100))
        ...
        // Day chrome
        self.chromeView = UIImageView(image: UIImage(named: "chrome"))
        ...
        self.amsterdamView = UIImageView(image: UIImage(named: "amsterdam"))
